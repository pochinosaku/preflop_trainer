...
function clearAnswer() {
    ...
    document.getElementById("image1").src = "images/cards/background.png";         // 画像をクリア(次のハンドが読み込まれるときに、1枚ずつ再更新されてタイムラグが発生するのを防ぐ)
    document.getElementById("image2").src = "images/cards/background.png";
}
